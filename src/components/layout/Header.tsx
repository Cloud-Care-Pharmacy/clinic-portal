      ...
      <div className="flex h-full items-center gap-3 px-4 pl-14 lg:pl-4">
        ...
        <div className="ml-auto flex items-center gap-3">
          <button
            ...
            className="hidden h-9 w-80 items-center gap-2.5 rounded-sm border border-input bg-background px-3 text-left text-sm text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/50 md:inline-flex"
