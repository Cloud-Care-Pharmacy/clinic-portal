...
export function ExpandableIconButton({
  ...
  return (
    <button
      className={cn(
        "group relative inline-flex h-9 min-w-9 items-center justify-center overflow-hidden rounded-sm border bg-muted px-2.5 text-muted-foreground transition-all duration-180 ease-in-out",
        disabled
